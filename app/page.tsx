...
export default function Home() {
  return <main id="top">
    ...
    <section className="home-grid">
      ...
      <div className="home-card project-feature"><p className="overline">PROJECTS</p><h2>Selected Research</h2><p>5G 특화망 보안, 양자보안 기반 기기 식별, 개방형 로밍, AirGap 환경의 스니핑 방지 기술을 연구합니다.</p><Link href="/projects">프로젝트 이력 →</Link></div>
