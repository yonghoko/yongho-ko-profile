...
export default function Home() {
  return <main id="top">
    ...
    <section className="home-grid">
      <div className="home-card academic-card"><p className="overline">RESEARCH</p><h2>Academic Profile</h2><ul>{areas.map(a=><li key={a}>{a}</li>)}</ul><div className="mini-metrics"><span><b>17</b> SCI Articles</span><span><b>3</b> Patents</span><span><b>1</b> Standard</span></div><Link href="/cv">전체 CV →</Link></div>
