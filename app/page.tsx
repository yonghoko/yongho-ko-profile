...
export default function Home() {
  return <main id="top">
    ...
    <section className="home-intro profile-intro">
      ...
      <div className="home-links"><a href="/cv">Academic CV 보기 →</a><a href="/projects">연구 프로젝트 보기 →</a></div></div>
    ...
    <section className="home-grid">
      <div className="home-card academic-card"><p className="overline">RESEARCH</p><h2>Academic Profile</h2><ul>{areas.map(a=><li key={a}>{a}</li>)}</ul><div className="mini-metrics"><span><b>17</b> SCI Articles</span><span><b>3</b> Patents</span><span><b>1</b> Standard</span></div><a href="/cv">전체 CV →</a></div>
      <div className="home-card project-feature"><p className="overline">PROJECTS</p><h2>Selected Research</h2><p>5G 특화망, 양자보안 기반 기기 식별, 개방형 로밍, AirGap 스니핑 방지 연구를 수행하고 있습니다.</p><a href="/projects">프로젝트 이력 →</a></div>
      <div className="home-card wine-feature"><p className="overline">PERSONAL NOTES</p><h2>Wine Notes</h2><p>마신 와인의 품종, 산지, 향과 구조, 그리고 한 줄의 인상을 기록합니다.</p><a href="/wine">Wine Notes →</a></div>
    </section>
