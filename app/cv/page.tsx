  ...
  return <main id="top">
    ...
    <div className="cv-shell">
      ...
      <article className="cv-content">
        ...
        <section className="cv-section" id="outputs"><div className="section-title-row"><h2>Intellectual Property & Standards</h2><span className="section-note">등록 3 · 출원 1 · 표준 1</span></div>
          <ol className="credential-list">
            <li><span className="credential-badge granted">등록 특허</span><span className="credential-id">US11914720B2</span><a href="https://patents.google.com/patent/US11914720B2/en" target="_blank" rel="noreferrer">A method for verifying drones in Industrial Internet of Things using Petri net modeling ↗</a></li>
            <li><span className="credential-badge granted">등록 특허</span><span className="credential-id">KR102491151B1</span><a href="https://doi.org/10.8080/1020210110719" target="_blank" rel="noreferrer">무인 항공기 보안 프로토콜 시스템 및 그 방법 ↗</a></li>
            <li><span className="credential-badge granted">등록 특허</span><span className="credential-id">KR102050230B1</span><a href="https://doi.org/10.8080/1020180075812" target="_blank" rel="noreferrer">페트리 넷 모델링을 이용한 산업용 사물 인터넷 시스템에 구비되는 드론의 검증방법 ↗</a></li>
            <li><span className="credential-badge pending">출원 중</span><span className="credential-id">10-2025-0032876</span><div><strong>Hybrid Post Quantum Cryptography Based 5G Authentication Protocol</strong><small>대한민국 · 특허 출원</small></div></li>
